...
export const MaterialSymbolInstances: { [key in MaterialSymbols]: Partial<Record<MaterialSymbolStyle, MaterialSymbolInstance[]>> } = {
    [MaterialSymbols.LIGHT_MODE]: {
        rounded: [
            ...
            },
            {
                opticalSize: "40px",
                svg: props =>
                    <svg {...props} xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 -960 960 960" width="40">
                        <path
    ...
    [MaterialSymbols.TIMER]: {
        rounded: [
            ...
            },
            {
                opticalSize: "20px",
                svg: props =>
                    <svg {...props} xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
                        <path
    ...
    [MaterialSymbols.CAPTIVE_PORTAL]: {
        rounded: [
            {
                opticalSize: "24px",
                svg: props =>
...
export type MaterialSymbolInstance = {
    ...
    grade?: -25 | 0 | 200,
    fill?: boolean
    svg: (props: HTMLProps<SVGSVGElement>) => ReactNode
}
